<div class="wrapper container-fluid">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::text('alias', $data['alias'],['class' => 'form-control','placeholder'=>'Введите псеводоним страницы']) !!}
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::file('images', ['class' => 'filestyle','data-buttonText'=>'Выберите изображение','data-button']) !!}
        </div>
    </div>
