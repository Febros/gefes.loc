                            ...
                            <div class="inner_section">
                                <div class="row">
                                    ...
                                    <div class=" col-lg-7 col-md-7 col-sm-7 col-xs-12 pull-left">
                                        ...
                                        <div class="work_bottom"> <span>Узнать больше..</span> <a href="{{route('page',array('alias'=>$page->alias))}}" class="contact_btn">Узнать</a> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!--client_logos-->
    ...
    @if(isset($peoples) && is_object($peoples))
        <section class="page_section team" id="team"><!--main-section team-start-->
            <div class="container">
                <h2>Команда</h2>
                <h6>Какой-нибудь текст лучше чем никакого</h6>
                <div class="team_section clearfix">
                    ...
                    @foreach($peoples as $k => $people)
                        <div class="team_area">
                            ...
                            <span class="wow fadeInDown delay-0{{ ($k*3+3) }}s">{{$people->status}}</span>
...
<footer class="footer_wrapper" id="contact">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 wow fadeInLeft delay-06s">
                    <div class="form">
                        ...
                        {{--<input class="input-btn" type="hidden" name="_token" value="{{ csrf_token()/*возвращает случайно сгенерированный ключ*/}}">--}}
                            {{ csrf_field() }} {{--генерирует скрытое поле для проверки--}}
    ...
    <div class="container">
        <div class="footer_bottom"><span>Все права защищены © 2017. </span> </div>
    </div>
</footer>